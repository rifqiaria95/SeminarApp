              ...
              <div
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="row">
                      <div class="col-12">
                        <h5 class="text-white mb-0 mt-2">Peserta</h5>
                      </div>
                      <div class="row">
                  ...
                  <div class="swiper-slide">
                    <div class="row">
                      <div class="col-12">
                        <h5 class="text-white mb-0 mt-2">Seminar</h5>
                      </div>
                      <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
                        <h6 class="text-white mt-0 mt-md-3 mb-3">Total Keseluruhan</h6>
                        <div class="row">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="d-flex gap-2 align-items-center mb-2">
                        <p class="mb-0">Menara Syariah is further envisaged to be the biggest Sharia Finance and Business hub in Asia.</p>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12">
              ...
              <div class="card">
                <div class="card-header d-flex justify-content-between pb-0">
                  <div class="card-title mb-0">
                    ...
                    @if(isset($seminar[0]))
                        <small class="text-muted">Diperbarui {{ $seminar[0]->created_at ? $seminar[0]->created_at->diffForhumans() : 'Belum ada data seminar' }}</small>
                    @else
                        <small class="text-muted">Belum ada data seminar</small>
                    @endif
                  </div>
                </div>
                <div class="card-body">
                      ...
                      <table class="table">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>{{ $sm->tanggal }}</td>
                                  <td>
                                    @foreach ($sm->pembicara as $pembicara)
                                      {{ $pembicara->nama_lengkap }}
                                    @endforeach
                                  </td>
                              </tr>
                              @endforeach
